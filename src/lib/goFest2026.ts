...
const mega: Record<string, GoFestPokemon> = {
  ...
  "mega-victreebel": { key: "mega-victreebel", name: "Mega Victreebel", types: ["Planta", "Venenoso"] },
  ...
  "mega-starmie": { key: "mega-starmie", name: "Mega Starmie", types: ["Água", "Psíquico"] },
  ...
  "mega-malamar": { key: "mega-malamar", name: "Mega Malamar", types: ["Sombrio", "Psíquico"] },
  "mega-raichu-x": { key: "mega-raichu-x", name: "Mega Raichu X" },
  "mega-raichu-y": { key: "mega-raichu-y", name: "Mega Raichu Y" },
  ...
  "mega-skarmory": { key: "mega-skarmory", name: "Mega Skarmory", types: ["Aço", "Voador"] },
  ...
  "mega-falinks": { key: "mega-falinks", name: "Mega Falinks", types: ["Lutador"] },
  ...
  "mega-dragonite": { key: "mega-dragonite", name: "Mega Dragonite", types: ["Dragão", "Voador"] },
...
export const GOFEST_DAYS: GoFestDay[] = [
  { key: "2026-08-31", weekday: "Segunda-feira", label: "31 AGO", event: "MEGA ASCENSÃO", slots: [slot(ascensionWild, ["mega-victreebel", "mega-dragonite", "mega-malamar"])] },
  { key: "2026-09-01", weekday: "Terça-feira", label: "01 SET", event: "MEGA ASCENSÃO", slots: [slot(ascensionWild, ["mega-falinks"])] },
  { key: "2026-09-02", weekday: "Quarta-feira", label: "02 SET", event: "MEGA ASCENSÃO", slots: [slot(ascensionWild, ["mega-skarmory"])] },
  { key: "2026-09-03", weekday: "Quinta-feira", label: "03 SET", event: "MEGA ASCENSÃO", slots: [slot(ascensionWild, ["mega-starmie"])] },
  { key: "2026-09-04", weekday: "Sexta-feira", label: "04 SET", event: "MEGA ASCENSÃO", slots: [slot(ascensionWild, ["mega-raichu-x", "mega-raichu-y"])] },
  { key: "2026-09-05", weekday: "Sábado", label: "05 SET", event: "MEGAFINAL", superRaids: ["mega-mewtwo-x"], slots: [
  ...
  { key: "2026-09-06", weekday: "Domingo", label: "06 SET", event: "MEGAFINAL", superRaids: ["mega-mewtwo-y"], slots: [
